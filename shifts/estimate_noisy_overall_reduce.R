...
file_path = 'figures_noisy_avg_reduced'
...
seir_outputs = simulate_seir(t, init_conditions, b, GAMMA, MU, randomize=TRUE, randomize_params=c(alpha=25,beta=10))
samples = rbbinom(100000, 100000, alpha=25, beta=10)
...
ggsave(paste(file_path, '/rt_cori_deconvolved.png', sep=''))
