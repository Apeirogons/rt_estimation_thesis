...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{figures/estim_ 1 .png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{figures/wt_vs_true_deterministic.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{figures/rt_ 1 .png}
